    ...
    return <Modal visible={this.state.modalVisible} onClosed={() => {
      this.setState({
        ...
        <View style={[styles.header]}>
          <TouchableHighlight onPress={onDismiss} style={[styles.headerItem]} underlayColor={colors.blue}>
            <Text>{dismissText}</Text>
          </TouchableHighlight>
          <View style={[styles.headerItem]}>
            <Text>{title}</Text>
          </View>
          <TouchableHighlight onPress={this.onOk} style={[styles.headerItem]} underlayColor={colors.blue}>
            <Text>{okText}</Text>
          </TouchableHighlight>
        </View>
