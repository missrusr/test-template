...
export default class Empty extends Component {
  ...
  render() {
    ...
    return <Flex direction="column" justify="center" align="center" {...props}>
        {xml && <Icon xml={xml} size={size} />}
        {!!children ? children : label && typeof label === 'string' && <Text style={StyleSheet.flatten([styles.label, labelStyle])}>
                {label}
              </Text>}
      </Flex>;
  }
