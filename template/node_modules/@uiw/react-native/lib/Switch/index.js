...
export default class Switch extends React.Component {
  ...
  animatedStart(checked) {
    if (checked) {
      Animated.parallel([Animated.sequence([Animated.spring(this.state.borderValue, {
        toValue: this.height,
      ...
      Animated.parallel([Animated.sequence([Animated.spring(this.state.bgOpacity, {
        toValue: 0,
        overshootClamping: true,
        useNativeDriver: false
  ...
  render() {
    ...
    return <View {...otherProps} onLayout={this.measureContainer} style={[styles.warpper, sizeStyl, style]}>
        {disabled && <View style={[styles.position, styles.disabled]} />}
        <Animated.View style={[styles.bg, styles.position, trackStyle, {
      ...
      style={[styles.position, {
        ...
        <Animated.View style={[styles.position, // eslint-disable-next-line react-native/no-inline-styles
      {
        backgroundColor: this.state.checked ? color : '',
        borderRadius: 16,
        opacity: this.state.bgOpacity
      }]} />
        <Animated.View style={[styles.grip, thumbStyle, disabled ? styles.shadowDisable : styles.shadow, {
