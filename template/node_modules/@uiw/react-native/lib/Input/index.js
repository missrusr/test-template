...
import { TextInput, View, StyleSheet, Platform, TouchableWithoutFeedback, Text, TouchableOpacity } from 'react-native';
...
export default class Input extends React.Component {
  ...
  render() {
    ...
    return <View style={inputStyles.container}>
        <TextInput editable={!disabled && editable} clearButtonMode={clear ? 'while-editing' : 'never'} underlineColorAndroid="transparent" ref={el => this.inputRef = el} {...restProps} {...valueProps} style={[inputStyles.input, error ? inputStyles.inputErrorColor : null, disabledStyle, // 支持自定义样式
      style]} keyboardType={keyboardType} onChange={event => this.onChange(event.nativeEvent.text)} secureTextEntry={type === 'password'} />
        {editable && clear && value && android ? <TouchableOpacity style={[inputStyles.clear]} onPress={this.onInputClear} hitSlop={{
        top: 5,
        left: 5,
        bottom: 5,
        right: 5
